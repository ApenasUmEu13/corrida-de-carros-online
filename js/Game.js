    ...
    if (allPlayers !== undefined) {
      ...
      for (var plr in allPlayers) {
       ...
       var vida = allPlayers[plr].life       
        //código que verifica se a vida é menor ou igual a 0
 if(vida <= 0){
...
gameState = 2;
        ...
        if (index === player.index) {
          ...
          this.colidiuComObstaculo(index);
...
//código que mostra a vida
  ...
  //código que verifica se houve colisão com o obstáculo

  colidiuComObstaculo(i){
...
this.perderVida()
  ...
  perderVida(){
   ...
   if(player.life > 0){
    ...
    //código para atualizar as novas informações no banco de dados
player.update()
  }
}
